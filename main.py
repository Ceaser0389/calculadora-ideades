...
# creando labels para frame cima
...
def calcular():
  ...
  # convertendo os valores em datetime
  data_nasc = date(ano_2, mes_2, dia_2)


  anos = relativedelta(data_inicial,data_nasc).years
  meses = relativedelta(data_inicial,data_nasc).months
  dias = relativedelta(data_inicial,data_nasc).days
...
l_data_inicial = Label(frame_baixo,text="Data inicial", width=25,height=1,padx=0,pady=0,relief='flat',anchor=NW,font=('Ivi 11'), bg=cor1, fg=cor3)
l_data_inicial.place(x=40,y=30)

cal_1 = DateEntry(frame_baixo,width=13, bg='darkblue', fg=cor3,borderwidth=2, date_pattern='mm/dd/yyyy',year=2026)
cal_1.place(x=180, y=30)

  

l_data_nascimento = Label(frame_baixo,text="Data de nascimento", width=25,height=1,padx=0,pady=0,relief='flat',anchor=NW,font=('Ivi 11'), bg=cor1, fg=cor3)
l_data_nascimento.place(x=40,y=70)

cal_2 = DateEntry(frame_baixo, width=13, bg='darkblue', fg=cor3,borderwidth=2, date_pattern='mm/dd/yyyy', year=2026)
...
l_app_nome = Label(frame_baixo,text="Anos", height=1,padx=0,pady=0,relief='flat',anchor='center',font=('Ivi 11 bold'), bg=cor1, fg=cor3)
l_app_nome.place(x=60,y=175)
...
l_app_dias_nome.place(x=225,y=175)
